...
<body>
    ...
    <div class="body">
        ...
        <section class="section-1">
            <h4 class="title">Chỉnh sửa công việc <a href="tasks.php">Danh sách công việc</a></h4>
            <form class="form-1"
                  method="POST"
            ...
            <?php } ?>
                <div class="input-holder">
                    <lable>Tiêu đề</lable>
                    <input type="text" name="title" class="input-1" placeholder="Tiêu đề" value="<?=$task['title']?>"><br>
                </div>
                <div class="input-holder">
                    <lable>Mô tả</lable>
                ...
                <div class="input-holder">
                    ...
                    <input type="date" name="due_date" class="input-1" placeholder="Hạn hoàn thành" value="<?=$task['due_date']?>"><br>
                </div>
